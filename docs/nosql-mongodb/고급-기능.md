...
> 💡 MongoDB는 **기본적인 작업** 외에도 다양한 **고급 기능**을 제공하여 더욱 효율적이고 강력한 데이터 관리를 가능하게 합니다. 여기서는 **Aggregation**, **인덱싱**, **트랜잭션**, **Change Streams**와 같은 고급 기능들을 살펴봅니다.
